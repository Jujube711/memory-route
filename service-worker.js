const CACHE = 'memory-route-v10';
const SHELL = ['./', './index.html', './manager.html', './config.js?v=7', './cloud-sync.js?v=8', './manifest.webmanifest', './assets/app-icon.svg', './assets/app-icon-192.png', './assets/app-icon-512.png', './assets/app-icon-maskable-512.png', './assets/apple-touch-icon.png', './assets/supabase.min.js?v=7'];
